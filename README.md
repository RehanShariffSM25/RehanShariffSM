I have tried to explain the logic with basic code snippet in the Readme file. If you access the files of the respective questions you can find the deatiled code for each question 
